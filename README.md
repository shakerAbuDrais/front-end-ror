...
**[hello rails front-end]** This project, created React, to simply show case front end and backend working together.
...
### Front-end
[front-end](https://github.com/shakerAbuDrais/front-end-ror)


### Backend
[back-end](https://github.com/shakerAbuDrais/front-end-ror)
...
```
  git clone https://github.com/shakerAbuDrais/front-end-ror
  cd react-ruby-hello
```
